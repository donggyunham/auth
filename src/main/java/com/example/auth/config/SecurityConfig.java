...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http
                .csrf(AbstractHttpConfigurer::disable)  // cors check disable
                .formLogin(AbstractHttpConfigurer::disable) // csrf check disable
                ...
                // UsernamePasswordAuthenticationFilter 보다 앞에 jwtAuthenticationFilter를 넣어라.
